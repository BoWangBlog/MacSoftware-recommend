...
[NeatDownloadManager](): 应用商店获取，联合NeatDownloadManager客户端，可以实现下载文件，下载速度很快；

[Screencastify](): 应用商店获取，浏览器录屏工具，非常好用；

[omni](): 应用商店获取，一款像mac上的快速搜索一样的工具，可以搜索标签页，支持数量也不少，还挺方便的；

[Bitwarden](): 应用商店获取，一款密码管理器，界面和交互都很友好；
